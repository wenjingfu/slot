...
Reel.prototype.wheel = function (){
	...
	if(self.stopFlag && self.currentSpeed <= self.minSpeed && self.indexs[1] == self.combination[self.stopNum][self.index] && self.reels[1].y + self.currentSpeed > 50){

		self.currentSpeed = 50 - self.reels[1].y;
		console.log("stop"+self.reels[1].y);
		console.log("stopv"+self.currentSpeed);
...
Reel.prototype.setY = function(){
	...
	if(self.reels[1].y + self.reels[1].height > 180){

		self.reels[1].height = 180 - self.reels[1].y;
	...
	if(self.reels[2].y > 180){

		self.reels[2].visible = false;

	}else if(self.reels[2].y + 80 > 180){

		self.reels[2].height = 180- self.reels[2].y;
		...
		if(self.reels[3].y < 180){

			self.reels[3].height = 180- self.reels[3].y;
